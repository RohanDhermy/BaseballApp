...
namespace RohanCrud.Tools
{
    public class DataMapper<T> where T : class
    {
        ...
        {
            IEnumerable<string> colnames = reader.GetSchemaTable().Rows.Cast<DataRow>().Select(c =>
            c["ColumnName"].ToString().ToLower()).ToList();
    ...
    public static class DataHelper
    {
        ...
        public static T GetParamValue<T>(this IDataParameter[] dbParams, string parameterName)
        {
