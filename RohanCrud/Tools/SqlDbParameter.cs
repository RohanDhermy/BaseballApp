...
namespace RohanCrud.Tools
{
    public class SqlDbParameter
    {
        ...
        public SqlParameter BuildParameter<T>(string paramName, T paramValue, SqlDbType paramType,
            int paramSize = 0, ParameterDirection paramDirection = ParameterDirection.Input)
        {
